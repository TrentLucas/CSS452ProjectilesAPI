...
class MyGame extends engine.Scene {
    ...
    init() {
        ...
        // Projectile Thing
        let renderable = new engine.TextureRenderable(this.kBullet);
        this.mPT = new engine.Projectile(renderable);
        this.mPT.mRenderComponent.getXform().setPosition(50, 40);
        this.mPT.mRenderComponent.getXform().setSize(5, 5);

        // let body = new engine.RigidRectangle(this.mPT.getXform(), 5, 5);
        // this.mPT.setRigidBody(body);
        // body.setVelocity(30, 30);
        
        this.mPT.setFrontRotOffset(-90);
        this.mPT.setAcc(.01);
        this.mPT.setVelocity(1);
        //this.mPT.mRenderComponent.getXform().setRotationInDegree(90);

        this.mPT.setRotationAcc(.5);
        this.mPT.setDirection(90);
        // this.mPT.setTarget(this.mHero);

        // this.mPT.setGravity(.1);
        // this.mPT.setGravityConstant(.02);
        // this.mPT.setGravityMax(2);

        // this.mPT.setLifeTime(120);
        this.mPT.setEndEvent(this.test, true);
    }
    ...
    update() {
        ...
        // engine.physics.processObjToSet(this.mPT, this.mAllObjs, this.mCollisionInfos);
